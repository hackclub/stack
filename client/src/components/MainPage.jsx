...
const navBlocks = [
  { label: "Shop", path: "/shop", className: "platform-main__block--shop", mtlUrl: shopMtlUrl, objUrl: shopObjUrl },
  { label: "User Area", path: "/user", className: "platform-main__block--user", mtlUrl: userAreaMtlUrl, objUrl: userAreaObjUrl },
  { label: "Projects", path: "/projects", className: "platform-main__block--projects", mtlUrl: prjMtlUrl, objUrl: prjObjUrl },
  { label: "FAQ", path: "/faq", className: "platform-main__block--faq", mtlUrl: faqMtlUrl, objUrl: faqObjUrl },
];
